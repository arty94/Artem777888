...
begin
  case messageBox(Handle,'Вы хотите перейти на авторизацию?','Выход', mb_YesNoCancel or mb_iconquestion) of
  IDYES:
  begin
       fAuth.Show;
     CanClose := True;
...
begin
    ...
    case MessageDlg('Вы действительно хотите удалить"'+ s +'a '+ s1+' '+s2+'а"?',
                mtInformation,
                [mbYes, mbNo],
                0)of
    IDYES: begin
...
begin
    SpeedButton3.Caption:='Должность'+#10+#13'(редактирование)';
end;
